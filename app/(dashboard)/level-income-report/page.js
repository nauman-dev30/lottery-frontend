...
export default function LevelIncomeReport() {
  ...
  const fetchReports = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE}/api/v1/getLevelIncomeReport`,
        {
          params: {
            ...
            senderId: columnFilters.senderId,
      ...
      if (response.data.success) {
        setReports(response.data.levelIncomeTransactions);
  ...
  const handleExportCSV = () => {
    ...
    const exportData = reports.map((r, index) => ({
      ...
      Sender: r.referal || "N/A",
      Amount: r.amount || "0",
      Timestamp: r.timestamp ? new Date(r.timestamp).toLocaleString() : "N/A",
    }));
    exportToCSV(exportData, "Level_Income_Report");
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Monitor your level income with detailed analytics and insights
          </p>
        </div>
                ...
                >
                  ...
                  >
                    ...
                    {/* <input
                      ...
                      value={columnFilters.senderId}
                      onChange={(e) => handleColumnFilterChange("senderId", e.target.value)}
                      style={{
                        marginTop: "8px",
                        width: "100%",
                        padding: "8px 12px",
                  ...
                  >
                    ...
                    <input
                      ...
                      value={columnFilters.senderId}
                      onChange={(e) =>
                        handleColumnFilterChange("senderId", e.target.value)
                      }
                      style={{
                        marginTop: "8px",
                        width: "100%",
                ...
                {reports.map((report, index) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "20px" }}>
                      ...
                      >
                        {report.referal
                          ? `${report.referal.slice(
                              0,
                              4,
                            )}....${report.referal.slice(-4)}`
                          : ""}
                      </a>
                    </td>
                    {address &&
