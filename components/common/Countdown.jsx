...
const CountdownTimer = ({ style = 1, targetDate = "2025-09-31T23:59:59" }) => {
  ...
  return (
    <>
      ...
      {style == 7 && (
        <div aria-hidden="true" className="simple-countdown" style={{ display: 'flex', gap: '6px', alignItems: 'center', color: '#ffffff', fontWeight: '700', fontSize: '14px' }}>
